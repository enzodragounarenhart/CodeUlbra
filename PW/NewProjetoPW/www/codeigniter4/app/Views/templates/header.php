        ...
        <section class="row">
            <nav class="col-md-3 p-3 text-center">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a id="product" class="nav-link" href="<?= base_url('products');?>">Produtos e Servicos</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <h3>Clientes</h3>
                    <li class="nav-item">
                        <a id="" class="nav-link" href="<?= base_url('listClients');?>">Listar Clientes</a>
                    </li>
                    <li class="nav-item">
                        <a id="" class="nav-link" href="<?= base_url('listProducts');?>">Listar Produtos</a>
                    </li>
                </ul>
            </nav>
